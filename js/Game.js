...
class Game{
    ...
    heightPos = new p5.Vector(50,50);
    heightSize = new p5.Vector(150,40);
    goalHeight = 10000;
    ...
    backButton = new UIElem(new p5.Vector(175,10),new p5.Vector(100,30),"Back to Menu!",UISmallText);

    winBox = new UIElem(new p5.Vector(250,50),new p5.Vector(150,40),"You win!",UIMediumText);
